...
const CourseSection = () => {
  ...
  return (
    <div className='mx-20 bg-cyan-100/10 py-12 '>
      <h2 className='text-2xl md:text-3xl text-gray-500  '>Learn From The Best Teachers </h2>
      <p className='text-sm text-gray-500 mt-8'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus rerum quod autem, ut earum est ex illo odit nesciunt <br/> quos quis quisquam, aliquid eum aspernatur deserunt, sunt facere exercitationem assumenda!</p>
